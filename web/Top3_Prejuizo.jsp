...
<body>
   ...
   <%   ArrayList<Cotacao> lista;
        ...
        lista = dao.get_cresc_negativo();
        float max = 10000, max1,max2,max3;
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Top 3 empresas que tiveram maior prejuizo'
    },
    subtitle: {
        text: 'IBOVESPA'
    },
    xAxis: {
        categories: [
            'Prejuizo no período de iserção'
        ],
        crosshair: true
    },
    yAxis: {
        min: 0,
        title: {
            text: 'Taxa de prejuízo (O valor representado é negativo)'
        }
    },
    tooltip: {
    ...
    <div class="panel panel-default">
        <div class="panel-body"><h3>Empresas que mais tiveram prejuízo </h3></div>
    </div>
    Desde o seu primeiro dia, a empresa <b>'<%out.print(top1);%>' </b>apresentou uma taxa de prejuízo de -<%out.print(max1);%><br />
    Entende-se como taxa de crescimento o valor da soma diferença da cotação máxima e mínima de cada dia do período.<br /><br />
    Em segundo lugar, a empresa <b>'<%out.print(top2);%>'</b> mostra o seu prejuízo com a taxa de -<%out.print(max2);%><br />
    E por último, em terceiro, a empresa <b>'<%out.print(top3);%>'</b> apresenta uma taxa de prejuízo de -<%out.print(max3);%><br />
    <br /><br />
</body>
</html>
